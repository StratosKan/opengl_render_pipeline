...
int main()
{
	...
	// ------------------------------------
	Shader lightingShader("Lighting_Maps_1/lightingMaps1.vs", "Test/customshader.fs");                     //"Lighting_Maps_2/lightingMaps2.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// material properties
		lightingShader.setFloat("material.shininess", shaderSpecShininess);
		...
		for (GLuint i = 0; i < 10; i++)
		{
			...
			lightingShader.setMat4("model", model);
			//glUniformMatrix4fv(VBO, 1, GL_FALSE, glm::value_ptr(model));
...
void processInput(GLFWwindow *window)
{
	...
	{
		shaderSpecShininess -= 0.2f;
		if (shaderSpecShininess <= 0.0f) 
		{
			shaderSpecShininess = 0.0f;
		}
		printf("Decreasing shininess to: %f ", shaderSpecShininess);
	}
	if (glfwGetKey(window, GLFW_KEY_E) == GLFW_PRESS)
	{
		...
		printf("Increasing shininess to: %f ", shaderSpecShininess);
	}
